...
// Universal Barber Bot - Handles all barbers dynamically
exports.universalBarberBot = onRequest({ 
  ...
  try {
    ...
    logger.info(`Universal Barber Bot - Customer: ${customer}, Message: ${message}`);
    ...
    logger.error("Error in Universal Barber Bot", err);
...
// Handle barber-specific operations
async function handleBarberOperations(message, barber, customer, today) {
  try {
    ...
    // Use AI to handle the request with barber context
